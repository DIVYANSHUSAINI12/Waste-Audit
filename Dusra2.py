...
creds = ServiceAccountCredentials.from_json_keyfile_name("C:\\Users\\Divyanshu\\Desktop\\Python Demo\\waste-ka-audit-b27a6f4efa97.json", scope)
...
with col2:
    st.image("logo4.jpg", width=100)

with col3:
    st.image('C:/Users/Divyanshu/Desktop/images.png', width=150)
